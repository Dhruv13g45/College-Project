...
const Aboutus = () => {
    return (
        <>
            <h2 className='text-[2rem] text-[#0e0e51] mx-10 mt-20 underline underline-offset-4 font-extrabold'>WHO WE ARE</h2>
            <h1 className='text-[3rem] text-[#0e0e51] mx-10 mt-2 underline underline-offset-4 font-extrabold'>A Legacy of Excellence</h1>
            <div className='w-full aboutSection lg:px-12 px-3 font-bold rounded-2xl flex flex-col lg:flex-row items-center justify-between gap-10'>
                <div className='w-full lg:w-1/2 aboutInfo text-[#0e0e51]'>
                    ...
                    <div className='grid grid-cols-2 gap-5 mt-10 font-bold'>
                        <div className='flex flex-col justify-center items-center px-10 py-3 rounded-2xl bg-blue-gray-100 gap-3'>
